...
#Class that displays stored passwords after login
class entity_display:
    ...
    def display(self):
        ...
        self.label_username.grid(row=6 + self.i, column=1)
...
username.grid(columnspan=3, row=2, column=1, padx=2, pady=2, sticky=W)
